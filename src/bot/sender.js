 ...
 * @param {string} nome - Nome do motorista para compor a mensagem.
 * @param {string} matricula - Matrícula do motorista para compor a mensagem.
 ...
 */
async function enviarMensagem(client, celular, media, nome, matricula) {
